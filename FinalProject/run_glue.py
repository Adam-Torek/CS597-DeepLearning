...
from modeling_electra import ElectraMOEConfig
from modeling_electra import ElectraMOEForSequenceClassification
...
def main():
    ...
    config = ElectraMOEConfig.from_pretrained(
    ...
    model = ElectraMOEForSequenceClassification.from_pretrained(
